...
async def pc(ctx):
    ...
    emBed.add_field(name="พิมพ์ !หัวข้อด้านล่าง ", value='string สตริง\nlist ลิสต์\nmath ฟังก์ชั่นคณิตศาสตร์\ndict ดิกชันนารี')
    emBed.add_field(name="รวมคลิปการเรียนการสอนวิชา PSIT", value='[PSIT2021 Week 01: Introduction](https://www.youtube.com/watch?v=l6Ui5svn-YU)\n
                                                                ', inline=False)
