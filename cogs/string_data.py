...
class string_data(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        # String เมทธอด find
            ...
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='สามารถใส่ค่า Parameter อีก 2 ตัวเพื่อให้เริ่มหาตำเเหน่งที่ตำเเหน่งไหนเเละหยุดหาที่ตำเเเหน่งไหน', inline=False)
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "Hello, welcome to my world." \n x = txt.find("e", 5, 10)\nprint(x)')
        ...
        # String เมทธอด index
            ...
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "Hello, welcome to my world."\nx = txt.index("e")\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value=1)
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='สามารถใส่ค่า Parameter เพิ่มอีกได้อีก 2 ตัวเพื่อให้เริ่มหาตำเเหน่งที่ตำเเหน่งไหนเเละหยุดหาที่ตำเเเหน่งไหน', inline=False)
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "Hello, welcome to my world." \n x = txt.find("e", 5, 10)\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value=8)
        ...
        # String เมทธอด ljust
            ...
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "banana"\nx = txt.ljust(20)\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value="banana              ")
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='สามารถใส่ค่า Parameter เพิ่มอีกตัวเพื่อเปลี่ยนจากช่องว่างเป็น String', inline=False)
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "banana" \n x = txt.ljust(20, "O"\nprint(x)')
        ...
        # String เมทธอด lstrip
            ...
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "       OOP  "\nx = txt.lstrip()\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value="OOP  ")
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='สามารถนำข้อความที่ไม่ต้องการทางด้านซ้ายออกได้โดยการใส่ค่า Parameter เพิ่มอีกตัวเป็นข้อความที่ต้องการเอาออก', inline=False)
        ...
        # String เมทธอด replace
            ...
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='ถ้ามีคำซ้ำหลายๆคำสามารถใส่ค่า Parameter เพิ่มอีกตัวกำหนดได้ว่าจะเเทนค่าเเค่กี่คำ', inline=False)
        ...
        # String เมทธอด rfind
            ...
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='สามารถใส่ค่า Parameter เพิ่มอีกตัวเพื่อให้เริ่มหาตำเเหน่งที่ตำเเหน่งไหนเเละหยุดหาที่ตำเเเหน่งไหน', inline=False)
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "Hello, welcome to my world."\nx = txt.rfind("e", 5, 10)\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value=8)
        ...
        # String เมทธอด strip
            ...
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "     banana     "\nx = txt.strip()\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value="banana")
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='ใส่ค่า Parameter อีกตัวเพื่อสามารถกำหนดว่าจะเอาข้อความตัวไหนออก', inline=False)
        ...
        # String เมทธอด split
            ...
            emBed.add_field(name="ตัวอย่างเพิ่มเติม", value='ใส่ค่า Parameter อีกตัวเพื่อสามารถกำหนดว่าจะเอาstringตัวทีจะให้เอาออกกี่ตัว', inline=False)
            emBed.add_field(name="ตัวอย่างโค้ด", value='txt = "apple#banana#cherry#orange""\nx = txt.split("#", 1)\nprint(x)')
            emBed.add_field(name="ผลลัพธ์", value="['apple', 'banana#cherry#orange']")
