...
class dict_data(commands.Cog):
    ...
    #ดิ้ก clear
            ...
            emBed.add_field(name="ลองใช้ clear", value='โดยการพิม !dclear(ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก copy
            ...
            emBed.add_field(name="ลองใช้ clear", value='โดยการพิม !dcopy (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก fromkeys
            ...
            emBed.add_field(name="ลองใช้ fromkeys", value='โดยการพิม !dfromkeys (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก get
            ...
            emBed.add_field(name="ลองใช้ get", value='โดยการพิม !dget (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก items
            ...
            emBed.add_field(name="ลองใช้ items", value='โดยการพิม !ditems (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก key
            ...
            emBed.add_field(name="ลองใช้ keys", value='โดยการพิม !dkey (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก pop
            ...
            emBed.add_field(name="ลองใช้ pop", value='โดยการพิม !dpop (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก popitem
            ...
            emBed.add_field(name="ลองใช้ popitem", value='โดยการพิม !dpopitem (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก setdefault
            ...
            emBed.add_field(name="ผลลัพธ์", value='Mustang')
            emBed.add_field(name="ลองใช้ setdefault", value='โดยการพิม !dsetdefault (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก update
            ...
            emBed.add_field(name="ลองใช้ update", value='โดยการพิม !dupdate (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
    ...
    #ดิ้ก values
            ...
            emBed.add_field(name="ลองใช้ values", value='โดยการพิม !dvalues (ข้อความที่ต้องการ)', inline=False)
            await message.channel.send(embed=emBed)
